...
// #ARKREP_MODIFIED_CODE : Added include related to metadata 
...
public:
	bool IsNonExecutableInPIE() const;
// !#ARKREP_MODIFIED_CODE 

// #ARKREP_MODIFIED_CODE : Added editor metadata related code
public:
	FFlowNodeEditorMetaData* GetEditorMetadata() const;

	/** True if the user as chosen to display this node metadata if any */
	UPROPERTY()
	bool AreEditorMetadataVisible { false };
// !#ARKREP_MODIFIED_CODE 
...
// #ARKREP_MODIFIED_CODE : Added 'start here' related functions
	FFlowGraphNodeEvent OnStartHereChanged {};

	bool GetStartHere() const;

	bool CanSetStartHere() const;
	bool CanSetCancelStartHere() const;

	void SetStartHere() const;
	void CancelStartHere() const;
// !#ARKREP_MODIFIED_CODE 
